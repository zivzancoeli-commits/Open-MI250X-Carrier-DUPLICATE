...
| `docs/EPYC_2P_OEM_MORE.md` | Research-only: remaining public 2P EPYC OEM manuals (H13/H14, MZ73, ASRock, HPE/Dell/Lenovo, ODM). Verified URLs only. Not a motherboard. |
