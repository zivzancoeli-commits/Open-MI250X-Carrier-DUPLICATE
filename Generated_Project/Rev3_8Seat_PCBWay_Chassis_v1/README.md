...
- 16× **Molex 218910-1115**. Outline **492 × 372 mm**. **12-layer 2.0 mm** stuffed-switch **target** (plan 12–16L, not 4). 8L 2.0 mm is a cheaper DNP-switch option only.
- All 8: named `P48V`/`P12V1`/`P3V3`/`GND`, named PE toward two **PM8536B-FEI DNP PRIMARY** (x8 per GCD; SW0 seats 0–3, SW1 4–7), per-seat REFCLK/PERST#/HOST_PWRGD. **PEX8780-AB80BI G** is a cheaper 80-lane alt in docs only.
...
| `docs/PCBWAY.md` | Guest quotes 2026-08-21. 12L stuffed-switch target vs 8L DNP option. Do not upload. |
| `docs/LAYER_STACK.md` | 12L 2.0 mm generated stuffed-switch stack. |
