...
| Layers (8×-running **target**) | **12L 2.0 mm** stuffed-switch (plan 12–16L, not 4) | Standard 1–14; 2.0 mm listed | Generated KiCad stack. Two DNP **PM8536B-FEI PRIMARY**. |
...
| **12L 2.0 mm Standard** | **$2237.90** | **$68.43** | **$2306.33** | 14–15 | **Stuffed-switch TARGET (this KiCad, two PM8536 DNP).** |
...
See `docs/LAYER_STACK.md`. Generated board = **12L 2.0 mm** stuffed-switch target. **8L 2.0 mm** is documented only as the cheaper DNP-switch option.
